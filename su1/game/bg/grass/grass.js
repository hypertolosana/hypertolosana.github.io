(function() {
    ...
    CAAT.Grass.prototype = {
        ...
        paint : function(ctx, time, ambient) {
            ...
            ctx.quadraticCurveTo(this.coords[2], this.coords[3],  px, py);

            ctx.quadraticCurveTo( this.coords[4], this.coords[5], this.coords[6], this.coords[7]);
            ctx.closePath();
            ctx.fillStyle = 'rgb(' +
...
(function() {
    CAAT.Garden = function() {
        CAAT.Garden.superclass.constructor.call(this);
        this.lerpindex= (Math.random()*this.colors.length)>>0;
        return this;
    };

    CAAT.Garden.prototype = {
        grass:            null,
        ambient:        1,
        stars:            null,
        firefly_radius:    10,
        ...
        initialize : function(ctx, size, maxGrassHeight, rotate) {
            this.grass = [];
        ...
        paint : function(director, time) {
            ...
            if (this.backgroundEnabled && this.rotate) {
                // lerp.
