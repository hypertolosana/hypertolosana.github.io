...
//                default:
        ...
        layoutHorizontal : function() {
            ...
            if ( this.horizontalLayout ) {
                ...
                this.addBehavior( new CAAT.AlphaBehavior().setValues(0,.75).setFrameTime(this.scene.time, 500) );
            }
        },
        ...
        paintActor : function( director, time ) {
            ...
            for( actor= this.activeChildren; actor; actor=actor.__next ) {
                if ( actor.inAnimation ) {
                    this.setBackgroundImage( this.prevBG );
                    SU.PileActor.superclass.paintActor.call( this, director, time );
                    return;
                }
            }
            ...
            if ( null===this.offImage ) {
                ...
                this.prevBG= this.backgroundImage;
                this.setBackgroundImage(canvas);
                this.offImage= canvas;
            }

            if ( this.width!=this.offImage.width || this.height!=this.offImage.height ) {
                var ctx= this.offImage.getContext('2d');

                var _director= {
                    ctx: ctx,
                    crc: ctx,
                    modelViewMatrix: new CAAT.Matrix().setTranslate( -me.x, -me.y )
                };
                SU.PileActor.superclass.paintActor.call( this, _director, time );
            }
            ...
            CAAT.Actor.prototype.paintActor.call(this,director,time);
        ...
        cardsAdded : function( addedCards, fromPile )    {
            ...
            for( i=0; i<addedCards.length; i++ ) {
                ...
                cardActor.moveTo(
                    ...
                    this.scene.time + (this.model.getActionCount()+i) * SU.CardActor.NEXT_ANIMATION_DELAY,
                    this.pile,
...
(function() {
    ...
    SU.PileActorWaste.prototype=    {
        ...
        doLayout : function(add) {
            ...
            // todas las cartas excepto las œltimas a–adidas.
...
//                    cesconder.setFrameTime(this.scene.time, Number.MAX_VALUE);
            ...
            for( i=0; i<a_mostrar; i++ ) {
                ...
                cmostrar.moveTo(
                    ...
                    this.scene.time + i*SU.CardActor.NEXT_ANIMATION_DELAY,
                    this.pile );
        ...
        cardsAdded : function( addedCards, fromPile )  {
            ...
            var rem= Math.min( pileSize, this.NC )-1;
            ...
            for( i=0; i<addedCards.length; i++ ) {
                ...
                // a–adir detr‡s del cosmŽtico de pulsaci—n.
...
/*
            for( i=0; i<addedCards.length; i++ ) {
                ...
                pileFromActor.removeChild(cardActor);
                this.addChildImmediately(cardActor);
                this.doLayout( addedCards.length );
            }
*/
        },
        ...
        initialize : function(director, scene, model)    {
            ...
            ///// moves
                ...
                var font= new CAAT.Font().
                    ...
                    createDefault(0);
//                font.save();
                var aa= new CAAT.Actor().setLocation(10,10);
                aa.nmoves= 0;
                aa.paint= function( director, time) {
                    var ctx= director.ctx;
                    font.drawText( ''+this.nmoves+' moves', ctx, 0, 0 );
                };
            ...
            ///// time
                var bb= new CAAT.Actor().setLocation( 250,10 );
                bb.paint= function( director, time ) {
                    var ctx= director.ctx;
