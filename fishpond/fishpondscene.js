...
function __scene_fish_pond(director, maxfish) {
    ...
    var ac= new CAAT.ImageActor().create().
            setImage( gr.cacheAsBitmap(0) );
    ...
    for( var i=0; i<maxfish; i++ ) {
        ...
        var pb= new CAAT.PathBehavior().
                ...
                setFrameTime(scene.time+inTime,(20000+20000*Math.random())>>0).
                setCycle(true).
                setAutoRotate(true).
                addListener( {
                                behaviorExpired : function(behavior, time, actor) {
                                    ...
                                    behavior.setFrameTime( scene.time,(20000+20000*Math.random())>>0);
                                    actor.born();
                                },
