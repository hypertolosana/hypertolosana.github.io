                    ...
                    if (-1 == this.prevTime || time - this.prevTime >= this.nextSmokeTime) {
                        ...
                        var humo =
                            new CAAT.Actor().
                                ...
                                ;
                        //CAAT.CSS.applyKeyframe( humo.domElement, 'smoke', this.smokeTime/1000, false );
    ...
    HN.GardenScene.prototype= {
        ...
        createHowtoButton : function( info_howto_ci ) {
            ...
            if ( CAAT.CSS3 ) {
                ...
                pbIn.setValueApplication( false );
                pbOut.setValueApplication( false );
            }
            ...
            _howto.mouseClick= function( e ) {
                ...
                if ( CAAT.CSS3 ) {
                    CAAT.CSS.applyKeyframe( _howto.domElement, 'HowtoOut', 1000 );
                }
            ...
            var howto= new CAAT.Actor().
                setAsButton(info_howto_ci.getRef(), 3,4,5,3,
                    function() {
                        ...
                        if ( CAAT.CSS3 ) {
                            CAAT.CSS.applyKeyframe( _howto.domElement, 'HowtoIn', 1000 );
                        }
        ...
        createInfoButton : function( info_howto_ci ) {
            ...
            _info.mouseClick= function( e ) {
                _info.emptyBehaviorList().
                    ...
                    addBehavior(pbOut.setFrameTime( me.directorScene.time, 1000 ));
                if ( CAAT.CSS3 ) {
                    CAAT.CSS.applyKeyframe( _info.domElement, 'infoOut', 1000 );
                }
            };
            ...
            var info= new CAAT.Actor().
                setAsButton(info_howto_ci.getRef(), 0,1,2,0,
                    function(button) {
                        ...
                        if ( CAAT.CSS3 ) {
                            CAAT.CSS.applyKeyframe( _info.domElement, 'infoIn', 1000 );
                        }
                    }).
